(function () {
  ...
  AppController.$inject = [ '$ionicPopup', '$scope', '$state', 'dataservice', 'AuthenticationService', '$ionicModal', '$timeout', '$ionicPlatform', '$cordovaCamera', '$cordovaImagePicker', '$localStorage', '$ionicSideMenuDelegate'];
  function AppController ( $ionicPopup, $scope, $state, dataservice, AuthenticationService, $ionicModal, $timeout, $ionicPlatform, $cordovaCamera, $cordovaImagePicker, $localStorage, $ionicSideMenuDelegate ){
