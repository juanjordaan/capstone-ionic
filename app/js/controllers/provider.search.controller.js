(function() {
  ...
  ProviderSearchController.$inject = ['$scope', 'dataservice', 'AuthenticationService', '$ionicModal', '$ionicPlatform', '$ionicPopup'];
  function ProviderSearchController($scope, dataservice, AuthenticationService, $ionicModal, $ionicPlatform, $ionicPopup) {
    var vm = this;
    vm.projects = [];
