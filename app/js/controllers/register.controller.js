(function () {
  ...
  RegisterController.$inject = ['$ionicPopup', '$scope', 'ionicModal', 'spinnerService', '$ionicPlatform', '$cordovaCamera', '$cordovaImagePicker'];
  function RegisterController($ionicPopup, $scope, ionicModal, spinnerService, $ionicPlatform, $cordovaCamera, $cordovaImagePicker){
    $scope.user = {};
    $scope.user._id = null;
